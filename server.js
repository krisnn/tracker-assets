...
const IDX_SECTORS = {
  ...
  GOTO: 'Technology', BUKA: 'Technology', EMTK: 'Technology', DMMX: 'Technology', NRCA: 'Construction',
  POWR: 'Consumer Discretionary', IPCC: 'Industrials', SMSM: 'Industrials'
};
...
const US_SECTORS = {
  ...
  SPY: 'ETF', QQQ: 'ETF', VTI: 'ETF', IWM: 'ETF', VOO: 'ETF', SCHD: 'ETF',
  QQQM: 'ETF',
...
async function fetchStock(sym) {
  ...
  return {
    symbol: sym, ticker, market, price, currency, changePercent,
...
async function fetchGoldPrice() {
  ...
  try {
    ...
    return {
      pricePerGram: Math.round(pricePerGram), currency: 'IDR',
